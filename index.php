...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/Chennai_Coffee.jpg" alt="Chennai" class="d-block w-100">
      <div class="carousel-caption">
        <h3>Chennai</h3>
        <p>We had such a great time in Chennai!</p>
      </div>   
    </div>
    <div class="carousel-item">
      <img src="img/rosogolla.jpg" alt="Kolkata" class="d-block w-100">
      <div class="carousel-caption">
        <h3>Kolkata</h3>
        <p>Thank you, Kolkata!</p>
      </div>   
    </div>
    <div class="carousel-item">
      <img src="img/coffee_foam_beverage_cup_saucer_creative_continents_84944_1920x1080 (1).jpg" alt="Jaipur" class="d-block w-100">
      <div class="carousel-caption">
        <h3>Jaipur</h3>
        <p>We love the Pink City!</p>
      </div>   
    </div>
  </div>
...
<div class="container-fluid">
     <div class="row"><!--main row-->
	   ...
	   <div class="col-sm-6">
	        ...
	        <div class="container">
	        <!--paragraph content--> 
	             <p style="font-family: 'Lobster', cursive; font-weight:light; font-size:25px;">Pasta is a type of food typically made from an unleavened dough of wheat flour mixed with water or eggs, and formed into sheets or other shapes, then cooked by boiling or baking. Rice flour, or legumes such as beans or lentils, are sometimes used in place of wheat flour to yield a different taste and texture, or as a gluten-free alternative. Pasta is a staple food of Italian cuisine.</p>
	        </div>
	  </div>
